...
static Key keys[] = {
    ...
    { MODKEY|GDK_SHIFT_MASK,GDK_x,      loaduri,      { .v = "file:///home/alex/Code/start.html" } },
    { MODKEY|GDK_SHIFT_MASK,GDK_t,      loaduri,      { .v = "https://check.torproject.org" } },
    { MODKEY|GDK_SHIFT_MASK,GDK_y,      loaduri,      { .v = "http://4chan.org" } },
    { MODKEY|GDK_SHIFT_MASK,GDK_a,      loaduri,      { .v = "http://localhost:7777" } },
